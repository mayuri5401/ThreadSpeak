---
id: "hld-interviews-search-aggregation-systems-design-search-autocomplete-system"
trackId: "system-design"
trackTitle: "System Design (LLD & HLD)"
category: "HLD Interviews - Search Aggregation Systems"
subSection: ""
title: "Design Search Autocomplete System"
slug: "hld-interviews-search-aggregation-systems-design-search-autocomplete-system"
summary: "In this chapter, we will explore the high-level design of a search autocomplete system."
...
codeSnippet:
  ...
  code: |
    class TrieNode:
        children: Dict[char, TrieNode]  # Next characters
        is_end_of_word: bool             # Is this a complete term?
        frequency: int                   # How often this term is searched
        last_updated: timestamp          # For recency scoring
        suggestions: List[str]           # Top N completions cached at this node
---
...
[Embed: https://link.excalidraw.com/readonly/w2seirgs8TXNOcU6UFWR](https://link.excalidraw.com/readonly/w2seirgs8TXNOcU6UFWR)
...
[Embed: https://link.excalidraw.com/readonly/VDx2Ykdxpfwg2uk4QOF4](https://link.excalidraw.com/readonly/VDx2Ykdxpfwg2uk4QOF4)
...
[Embed: https://link.excalidraw.com/readonly/qNFcdsGvTZBmsAwEOED0](https://link.excalidraw.com/readonly/qNFcdsGvTZBmsAwEOED0)
...
[Embed: https://link.excalidraw.com/readonly/WyPql4tMDNq4Qxhjr6UD](https://link.excalidraw.com/readonly/WyPql4tMDNq4Qxhjr6UD)
...
```json
lru_cache = {
  "new": ["new york", "new balance", "new delhi"],
  "how": ["how to cook rice", "how to code", "how to invest"]
}
```
...
```shell
score= α⋅popularity + β⋅recency + γ⋅CTR + δ⋅personalization+...
```
...
```shell
distance("googel", "google") = 1 (swap ‘e’ and ‘l’)
distance("googel", "good") = 2   (swap ‘l’ and ‘p’)
distance("googel", "gold") = 3   (missing ‘e’)   
```
...
```shell
| Term  | N-grams        | Commonality with “aple” |
| ----- | -------------- | ----------------------- |
| apple | ap, pp, pl, le | 3 / 4 = 0.75            |
| ample | am, mp, pl, le | 2 / 4 = 0.5             |
| apply | ap, pp, pl, ly | 2 / 4 = 0.5             |
```
