---
id: "hld-interviews-asynchronous-systems-design-a-scalable-notification-service"
trackId: "system-design"
trackTitle: "System Design (LLD & HLD)"
category: "HLD Interviews - Asynchronous Systems"
subSection: ""
title: "Design a Scalable Notification Service"
slug: "hld-interviews-asynchronous-systems-design-a-scalable-notification-service"
summary: "In this chapter, we will walk through the high-level design of a notification service."
eli10: "Imagine Design a Scalable Notification Service as a well-organized city blueprint where every service and class has a single clear purpose, working together without chaos."
mentalModel: "Design a Scalable Notification Service Architecture Flow: Clients -> Load Balancer / API Gateway -> Services & Core Entities -> Storage & Cache."
difficulty: "Advanced"
estimatedMinutes: 15
tags: ["HLD Interviews","Asynchronous Systems","System Design","Architecture"]
codeSnippet:
  language: "json"
  explanation: "Production implementation for Design a Scalable Notification Service"
  code: |
    {
      "requestId": "abc123",
...
[Embed: https://link.excalidraw.com/readonly/PRP896QFX6VNuJTvxG0B](https://link.excalidraw.com/readonly/PRP896QFX6VNuJTvxG0B)
...
> **Example:**
>
>  Users may opt out of marketing or promotional content
...
> **Example:**
>
>  A promotional message might be scheduled for delivery next week.
...
[Embed: https://link.excalidraw.com/readonly/4EVfTAPQWT6oy7YUELAn](https://link.excalidraw.com/readonly/4EVfTAPQWT6oy7YUELAn)
...
```shell
Email: HTML or plain text with headers, footers, and attachments.

SMS: Plain text with a maximum character limit.

Push Notification: A concise message with metadata for app actions.

In-app Notification: JSON payload formatted for display in the app.
```
...
> **Example:**
>
>  If the notification needs to be sent via email, SMS, and push, the Notification Service generates 
>
> **three messages**
>
> , each tailored to the respective channel.
...
[Embed: https://link.excalidraw.com/readonly/nZsgb5RWduiAwB4EfiQf](https://link.excalidraw.com/readonly/nZsgb5RWduiAwB4EfiQf)
...
>
> : Store data in multiple availability zones to provide redundancy.
