---
id: "hld-interviews-real-time-communication-design-google-docs"
trackId: "system-design"
trackTitle: "System Design (LLD & HLD)"
category: "HLD Interviews - Real Time Communication"
subSection: ""
title: "Design Google Docs"
slug: "hld-interviews-real-time-communication-design-google-docs"
summary: "To design a system like Google Docs, we must solve several complex challenges like:"
eli10: "Imagine Design Google Docs as a well-organized city blueprint where every service and class has a single clear purpose, working together without chaos."
mentalModel: "Design Google Docs Architecture Flow: Clients -> Load Balancer / API Gateway -> Services & Core Entities -> Storage & Cache."
difficulty: "Advanced"
estimatedMinutes: 15
tags: ["HLD Interviews","Real Time Communication","System Design","Architecture"]
codeSnippet:
  language: "json"
  explanation: "Production implementation for Design Google Docs"
  code: |
    {
      "type": "insert",
      "position": 42,
...
[Embed: https://link.excalidraw.com/readonly/RY0ZXLhLdSTOvIoQZdAB](https://link.excalidraw.com/readonly/RY0ZXLhLdSTOvIoQZdAB)
...
[Embed: https://link.excalidraw.com/readonly/NXMpMazGPt4KB7XiE8Ja](https://link.excalidraw.com/readonly/NXMpMazGPt4KB7XiE8Ja)
  ...
  "content": [
    {
      "type": "heading",
      "attrs": { "level": 1 },
      "content": [{ "type": "text", "text": "Google Docs System Design" }]
    },
    {
      "type": "paragraph",
      "content": [{ "type": "text", "text": "This document explains the high-level architecture." }]
    },
    {
      "type": "bullet_list",
      "content": [
        {
          "type": "list_item",
          "content": [{ "type": "paragraph", "content": [{ "type": "text", "text": "Real-time editing" }] }]
        },
        {
          "type": "list_item",
          "content": [{ "type": "paragraph", "content": [{ "type": "text", "text": "Offline support" }] }]
        },
        {
          "type": "list_item",
          "content": [{ "type": "paragraph", "content": [{ "type": "text", "text": "Access control" }] }]
        }
      ]
    }
  ]
...
```json
{
  ...
  "marks": [
    { "type": "bold" },
    { "type": "italic" }
    { "type": "link", "href": "https://yourwebsite.com/system-design" }
  ]
}
```
...
> **recent snapshots**
>
>  in a fast-access store (e.g., MongoDB). Move 
>
> **older snapshots**
>
>  to long-term blob storage.
...
>
> **fast, memory-efficient replay**
>
> , and scales to documents with years of editing history.
...
```json
{
  ...
  "last_activity": "2025-05-08T14:33:12Z",
  "cursor_position": {
    "block_id": "para_12",
    "offset": 42
  },
...
```json
{
  ...
  "title": "System Design Notes",
  "owner_id": "user_456",
  "updated_at": "2025-05-08T12:45:00Z"
}
```
...
{
  "document_id": "doc_123",
  "content_blob": { ...structured content... },
  "version": 42
}
```
...
[
  {
    "version_number": 40,
    "created_by": "user_456",
    "timestamp": "2025-05-08T12:10:00Z"
  },
  {
    "version_number": 41,
    "created_by": "user_789",
    "timestamp": "2025-05-08T12:12:15Z"
  }
]
```
...
> If two operations conflict (e.g., both insert at the same position), the server transforms the 
>
> **second**
>
>  operation to account for the 
>
> **first**
>
> , preserving the intent of both.

**Example: **Let’s say the document is initially: `"BC"`

Two users edit concurrently:

[Embed: https://link.excalidraw.com/readonly/cHnJxEjThUU0aLGbF1eo](https://link.excalidraw.com/readonly/cHnJxEjThUU0aLGbF1eo)
...
```shell
Version 25 | Alice | May 8, 2025 - 2:45 PM
Version 24 | Bob   | May 8, 2025 - 2:30 PM
Version 23 | Alice | May 8, 2025 - 2:15 PM
...
```
...
```json
{
  ...
  "operation": {
    "type": "replace_all",
    "content": { ...reconstructed content from version 52... }
  },
  "user_id": "user_456",
...
```json
[
  { "type": "insert", "position": 0, "content": "Hello", "timestamp": 1715180000000 },
  { "type": "delete", "position": 10, "length": 3, "timestamp": 1715180005000 },
  { "type": "format", "position": 5, "length": 10, "style": "bold", "timestamp": 1715180010000 }
]
```
