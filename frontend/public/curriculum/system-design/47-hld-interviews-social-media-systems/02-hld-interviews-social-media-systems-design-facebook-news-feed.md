---
id: "hld-interviews-social-media-systems-design-facebook-news-feed"
trackId: "system-design"
trackTitle: "System Design (LLD & HLD)"
category: "HLD Interviews - Social Media Systems"
subSection: ""
title: "Design Facebook News Feed"
slug: "hld-interviews-social-media-systems-design-facebook-news-feed"
summary: "Building such a system that delivers this experience to 100 million+ daily active users (DAUs) is anything but simple."
eli10: "Imagine Design Facebook News Feed as a well-organized city blueprint where every service and class has a single clear purpose, working together without chaos."
mentalModel: "Design Facebook News Feed Architecture Flow: Clients -> Load Balancer / API Gateway -> Services & Core Entities -> Storage & Cache."
difficulty: "Advanced"
estimatedMinutes: 15
tags: ["HLD Interviews","Social Media Systems","System Design","Architecture"]
codeSnippet:
  language: "shell"
  explanation: "Production implementation for Design Facebook News Feed"
  code: |
...
[Embed: https://link.excalidraw.com/readonly/DzI2nyXxbLfi6GBnA50S](https://link.excalidraw.com/readonly/DzI2nyXxbLfi6GBnA50S)
...
[Embed: https://link.excalidraw.com/readonly/VI9y2bvRqMZVy3GOKeqm](https://link.excalidraw.com/readonly/VI9y2bvRqMZVy3GOKeqm)
...
[Embed: https://link.excalidraw.com/readonly/w9rVLdThmTDd4vGrSYL2](https://link.excalidraw.com/readonly/w9rVLdThmTDd4vGrSYL2)
...
[Embed: https://link.excalidraw.com/readonly/SRvuQ9uPdnellIrYARIN](https://link.excalidraw.com/readonly/SRvuQ9uPdnellIrYARIN)
...
[Embed: https://link.excalidraw.com/readonly/fb3wJ8OlGT7NpUzcrhtj](https://link.excalidraw.com/readonly/fb3wJ8OlGT7NpUzcrhtj)
...
6. For each follower:
   1. Add the `post_id` to their **feed cache** or persistent feed store
   2. If online, send a **real-time update** via WebSocket (optional)
...
WHERE user_id = :uid AND post_id > :after_id
...
```json
{ "type": "new_post", "post_id": 12345 }
{ "type": "notification", "message": "User B liked your post." }
```
...
```shell
Client → Kafka → Streaming/Batch Processing (e.g., Spark, Flink) → Data Lake → Feature Store → Model Training
```
